...
For Python, see `//pyatdllib/ui/immaculater.py` and `(cd ../pyatdllib &&
runme.sh sh --database_filename
...
'Download Your Data' page and clicking on 'Download Your Data'.
...
ctx_list {
  common {
    is_deleted: false
    timestamp {
      ctime: 1558073250920191
      dtime: -1
      mtime: 1558073250920208
    }
    metadata {
      name: "Contexts"
    }
